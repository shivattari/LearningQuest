...
document.querySelector(".dropbtn").addEventListener("click", () => {
    if (droppedDown) {
        document.querySelector(".open-drop").style.display = "block";
        document.querySelector(".close-drop").style.display = "none";
        
        document.querySelector("nav").classList.toggle("vertical-nav");

        document.querySelector(".left-items").style.display = "none";
        document.querySelector(".left-items .nav-logo").style.display = "block";
        document.querySelector(".right-items").style.display = "none";
